<section class="full-width pageContent">
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="mdl-tabs__tab-bar">
			    ...
			    <a href="#listaCategoria" class="mdl-tabs__tab" onclick="listaCategoria('');">LISTA</a>
			</div>
			<div class="mdl-tabs__panel is-active" id="tabListCate">
				<div class="mdl-grid">
									...
									<form action="" method="POST" autocomplete="">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
											...
											<div class="mdl-textfield__expandable-holder">
												<input class="" type="" placeholder="Nombre Categoria" onkeyup="listaCategoria(this.value)">
